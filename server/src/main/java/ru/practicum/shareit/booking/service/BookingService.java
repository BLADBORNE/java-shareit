...
public interface BookingService {
    ...
    List<Booking> getUserBookings(int userId, BookingStatus status, int from, int size);

    List<Booking> getOwnerBookings(int userId, BookingStatus status, int from, int size);
}